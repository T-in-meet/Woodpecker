...
VALUES
  (
    current_setting('test.notes_fk_user_valid_id')::uuid,
    'user_valid_' || current_setting('test.notes_fk_user_valid_id') || '@example.com',
    '{}'::jsonb
  ),
  (
    current_setting('test.notes_fk_user_delete_cascade_id')::uuid,
    'user_delete_cascade_' || current_setting('test.notes_fk_user_delete_cascade_id') || '@example.com',
    '{}'::jsonb
  ),
  (
  ...
  (
    current_setting('test.notes_fk_user_stale_id')::uuid,
    'user_stale_' || current_setting('test.notes_fk_user_stale_id') || '@example.com',
    '{}'::jsonb
  ),
  (
    current_setting('test.notes_fk_user_multi_id')::uuid,
    'user_multi_' || current_setting('test.notes_fk_user_multi_id') || '@example.com',
    '{}'::jsonb
  ),
  (
...
VALUES
  (
    current_setting('test.notes_fk_note_delete_cascade_id')::uuid,
    current_setting('test.notes_fk_user_delete_cascade_id')::uuid,
    'cascade seed note',
...
DELETE FROM auth.users WHERE id = current_setting('test.notes_fk_user_delete_cascade_id')::uuid;
SELECT is(
...
SELECT throws_ok(
  format(
    ...
    $sql$,
    current_setting('test.notes_fk_note_invalid_insert_id'),
...
DELETE FROM auth.users WHERE id = current_setting('test.notes_fk_user_stale_id')::uuid;
SELECT throws_ok(
  format(
    $sql$
      INSERT INTO public.notes (id, user_id, title, content, review_round)
    ...
    $sql$,
    current_setting('test.notes_fk_note_stale_insert_id'),
...
VALUES
  (
    current_setting('test.notes_fk_note_multi_1_id')::uuid,
    current_setting('test.notes_fk_user_multi_id')::uuid,
    'multi note 1',
    'multi content 1',
    0
  ...
  (
    current_setting('test.notes_fk_note_multi_2_id')::uuid,
    current_setting('test.notes_fk_user_multi_id')::uuid,
    'multi note 2',
    'multi content 2',
    0
...
DELETE FROM auth.users WHERE id = current_setting('test.notes_fk_user_multi_id')::uuid;
SELECT is(
