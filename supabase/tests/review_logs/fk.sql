...
VALUES
  ...
  (current_setting('test.note_fk_cascade_log_n1')::uuid, current_setting('test.note_fk_cascade_note_nchild')::uuid, current_setting('test.note_fk_cascade_user_a')::uuid, 2, now() + interval '3 days', TIMESTAMPTZ '2026-02-01 00:00:00+00'),
  (current_setting('test.note_fk_cascade_log_n2')::uuid, current_setting('test.note_fk_cascade_note_nchild')::uuid, current_setting('test.note_fk_cascade_user_a')::uuid, 3, now() + interval '4 days', TIMESTAMPTZ '2026-02-02 00:00:00+00'),
  (current_setting('test.note_fk_cascade_log_n3')::uuid, current_setting('test.note_fk_cascade_note_nchild2')::uuid, current_setting('test.note_fk_cascade_user_a')::uuid, 2, now() + interval '5 days', TIMESTAMPTZ '2026-02-03 00:00:00+00'),
  (current_setting('test.note_fk_cascade_log_n4')::uuid, current_setting('test.note_fk_cascade_note_nchild2')::uuid, current_setting('test.note_fk_cascade_user_a')::uuid, 3, now() + interval '6 days', TIMESTAMPTZ '2026-02-04 00:00:00+00'),
