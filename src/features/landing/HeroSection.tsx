...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute -right-40 -top-40 -z-10 size-96 rounded-full bg-gradient-to-br from-amber-200/40 to-orange-200/40 blur-3xl dark:from-amber-800/10 dark:to-orange-800/10" />
      <div className="absolute -bottom-20 -left-40 -z-10 size-80 rounded-full bg-gradient-to-tr from-rose-200/40 to-pink-200/40 blur-3xl dark:from-rose-800/10 dark:to-pink-800/10" />
