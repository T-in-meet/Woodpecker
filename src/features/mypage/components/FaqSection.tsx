...
const FAQ_ITEMS: FaqItem[] = [
  {
    ...
    answer:
      "노트를 작성하면 1일 뒤 첫 복습이 시작되고, 이후에는 3일 → 7일 → 14일 → 30일 간격으로 복습합니다. 30일 단계 이후에도 같은 간격으로 계속 이어지며, 복습 횟수에 따른 자동 종료는 없습니다. 학습을 마치고 싶다면 노트 상세 화면의 ⋯ 메뉴에서 '학습 종료로 표시'를 선택할 수 있고, 필요할 때 다시 시작할 수 있습니다.",
  },
  {
    category: "learning",
  ...
  },
  {
    ...
    answer:
      "노트 상세 화면 오른쪽 위의 ⋯ 메뉴에서 '복습 일정 변경'을 선택하면 다음 복습 날짜와 알림 시각을 직접 지정할 수 있습니다. 날짜를 옮기면 현재 예정된 복습 일정이 함께 이동합니다. 학습 종료로 표시한 노트는 '복습 다시 시작'을 선택해 알림과 복습을 이어갈 수 있습니다.",
  },
  {
    category: "notifications",
  ...
  },
  {
    category: "learning",
    question:
      "학습 통계의 연속 학습일과 예정일에 맞춘 복습은 어떻게 계산되나요?",
    answer:
      "모두 한국 시간 기준입니다. 연속 학습일은 복습을 완료한 날이 하루도 끊기지 않고 이어진 일수로, 오늘 아직 복습하지 않았어도 어제까지 이어졌다면 기록이 유지됩니다. 예정일에 맞춘 복습은 완료한 복습 중 예정일 당일까지 마친 비율이며, 잔디 그래프는 최근 30일의 복습 완료 건수를 보여줍니다.",
  },
  {
    category: "account",
