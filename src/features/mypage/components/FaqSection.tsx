...
const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "하루에 5회까지 받을 수 있고, 사용 횟수는 매일 자정에 초기화됩니다. 한도를 다 쓰더라도 백지 테스트와 복습 완료는 그대로 할 수 있고, 지난 채점 기록도 계속 볼 수 있습니다.",
  },
  {
    category: "learning",
  ...
  },
  {
    ...
    answer:
      "연속 학습일은 복습을 완료한 날이 하루도 끊기지 않고 이어진 일수로, 오늘 아직 복습하지 않았어도 어제까지 이어졌다면 기록이 유지됩니다. 정시 완료율은 완료한 복습 중 예정일 당일까지 마친 비율이며, 잔디 그래프는 최근 30일의 복습 완료 건수를 보여줍니다.",
  },
  {
    category: "account",
