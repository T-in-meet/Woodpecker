...
/**
 * 하나의 Note에 대해 하루 동안 실행할 수 있는
 * Related Notes AI 추천의 최대 횟수입니다.
 *
 * 관리자 계정은 운영 및 AI 기능 검증을 위해 DB claim RPC 내부에서
 * 이 제한을 건너뜁니다.
 */
export const RELATED_NOTES_DAILY_RECOMMENDATION_LIMIT_PER_NOTE = 1;
