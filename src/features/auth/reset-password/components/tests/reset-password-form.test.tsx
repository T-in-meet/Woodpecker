...
describe("reset-password-form", () => {
  ...
  it("TC22: idle에서는 global error UI를 표시하지 않는다", () => {
    renderResetPasswordForm();
  ...
  it("TC23: idle에서는 입력한 민감값을 화면 텍스트로 노출하지 않는다", () => {
    renderResetPasswordForm();
  ...
  it("TC24: idle에서는 성공 UI를 표시하지 않는다", () => {
    renderResetPasswordForm();
  ...
  it("TC25: idle에서는 rejected UI를 표시하지 않는다", () => {
    renderResetPasswordForm();
