...
export const GUIDE_DOCUMENTS = [
  ...
  {
    slug: "review-cycle",
    title: "복습 주기는 어떻게 정할까? 간격과 일정 예시",
    heading: "복습 주기는 어떻게 정할까",
    description:
      "복습 주기에 정답이 있을까요? 복습할수록 간격을 넓히는 이유, 고정형과 적응형 복습 주기의 차이, 1일·3일·7일·14일·30일처럼 직접 복습 일정을 만드는 방법을 정리했습니다.",
    summary: "언제 다시 복습하는 것이 좋은지 알아봅니다.",
    revisedOn: "2026-09-10",
  },
  {
    slug: "blank-test",
    title: "백지 테스트란? 하는 방법부터 채점·복습까지",
    heading: "백지 테스트하는 법",
    description:
...
export const GUIDE_INDEX_CONTENT = {
  ...
  description:
    "간격 반복 학습, 복습 주기, 백지 테스트 — 배운 내용을 오래 기억하기 위한 복습 방법을 세 편의 글로 정리했습니다.",
  /**
  ...
  intro: [
    ...
    "이 가이드에서는 이 세 단계를 간격 반복 학습 → 복습 주기 → 백지 테스트 순서로 설명합니다.",
  ],
