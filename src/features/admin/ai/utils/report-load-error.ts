...
type ReportAdminAiLoadErrorInput = {
  /** 현재 관리자 사용자 ID */
  adminUserId: string;
 ...
 *
 * @param input 관리자 AI 조회 오류 정보
 */
export async function reportAdminAiLoadError(
  input: ReportAdminAiLoadErrorInput,
) {
