  ...
  return (
    <main className="min-h-screen bg-stone-50">
      ...
      <div className="mx-auto max-w-3xl px-6 py-12">
        {/* Intro */}
        <div className="mb-10 rounded-xl border px-6 py-5 text-center">
          <p className="text-sm leading-relaxed">
            딱다구리는 개인정보보호법 등 관련 법령에 따라 이용자의 개인정보를
            보호하고, <br />
            이와 관련한 고충을 신속하고 원활하게 처리합니다.
          </p>
        </div>
        ...
        <div className="mt-10 rounded-xl border border-stone-200 bg-white px-6 py-5">
          <p className="text-xs text-stone-400">
            부칙: 이 개인정보 처리방침은 {EFFECTIVE_DATE}부터 시행합니다.
          </p>
        </div>
      </div>
    </main>
