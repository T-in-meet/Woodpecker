...
SELECT set_config('test.u5', gen_random_uuid()::text, false);

SELECT set_config('test.u6', gen_random_uuid()::text, false);
...
SELECT set_config('test.u1_t0', (SELECT updated_at::text FROM public.profiles WHERE id = current_setting('test.u1')::uuid), false);
SELECT set_config('test.u2_t0', (SELECT updated_at::text FROM public.profiles WHERE id = current_setting('test.u2')::uuid), false);
SELECT set_config('test.u3_t0', (SELECT updated_at::text FROM public.profiles WHERE id = current_setting('test.u3')::uuid), false);
SELECT set_config('test.u4_t0', (SELECT updated_at::text FROM public.profiles WHERE id = current_setting('test.u4')::uuid), false);
SELECT set_config('test.u5_t0', (SELECT updated_at::text FROM public.profiles WHERE id = current_setting('test.u5')::uuid), false);
SELECT set_config('test.u6_t0', (SELECT updated_at::text FROM public.profiles WHERE id = current_setting('test.u6')::uuid), false);
...
SELECT set_config('test.u6_t1', (SELECT updated_at::text FROM public.profiles WHERE id = current_setting('test.u6')::uuid), false);
